        ...
        <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
            ...
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                ...
                @canany(['access users', 'access premium users'])
                    ...
                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                        <span class="menu-link">
                            ...
                            <span class="menu-title">{{ __('Mobile Users') }}</span>
                            <span class="menu-arrow"></span>
                        </span>
                        <div class="menu-sub menu-sub-accordion menu-active-bg">
                            <div class="menu-item">
                                <a class="menu-link   {{ Request::segment(2) == 'customers' ? ' active' : '' }}"
                            ...
                            <div class="menu-item">
                                <a class="menu-link   {{ Request::segment(2) == 'owners' ? ' active' : '' }}"
                                    ...
                                    <span class="menu-title">{{ __('Owners') }}</span>
                                </a>
                ...
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                    ...
                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                        <div class="menu-item">
                            <a class="menu-link   {{ Request::segment(2) == 'entertainments' ? ' active' : '' }}"
                                href="{{ route('admin.entertainments.index') }}">
                                <span class="menu-icon">
                                    <!--begin::Svg Icon | path: icons/duotone/Design/PenAndRuller.svg-->
                                    <span class="svg-icon svg-icon-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px"
                                ...
                                <span class="menu-title">{{ __('Entertainments') }}</span>
                            </a>
                        </div>
                    </div>
                </div>
