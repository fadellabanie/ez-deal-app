    ...
    <div class="card card-flush mt-6 mt-xl-9">
        <div class="card-header mt-5">
            <div class="card-title flex-column">
                <h3 class="fw-bolder mb-1">{{__("Customers")}}</h3>
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="me-5 position-relative">
                                            <div class="symbol symbol-35px symbol-circle">
                                                <img alt="Pic" src="{{asset($customer->avatar)}}">
                                            </div>
                                        </div>
                                        <div class="d-flex flex-column justify-content-center">
                                            <a href="{{route('admin.customers.show',$customer)}}"
                                                class="fs-6 text-gray-800 text-hover-primary">{{$customer->first_name.$customer->last_name}}</a>
                                            <div class="fw-bold text-gray-400">{{$customer->email}}</div>
                                            <div class="fw-bold text-gray-400">{{$customer->mobile}}</div>
                                        </div>
                                    </div>
                                </td>
                                <td wire:click="freeze({{$customer->id}})">
                                    {!!userStatus($customer->suspend)!!}</td>
