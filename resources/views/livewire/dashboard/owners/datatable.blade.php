                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="me-5 position-relative">
                                            <div class="symbol symbol-35px symbol-circle">
                                                <img alt="Pic" src="{{asset($owner->avatar)}}">
                                            </div>
                                        </div>
                                        <div class="d-flex flex-column justify-content-center">
                                            <a href="{{route('admin.owners.show',$owner)}}"
                                                class="fs-6 text-gray-800 text-hover-primary">{{$owner->first_name.$owner->last_name}}</a>
                                            <div class="fw-bold text-gray-400">{{$owner->email}}</div>
                                            <div class="fw-bold text-gray-400">{{$owner->mobile}}</div>
                                        </div>
                                    </div>
                                </td>
                                <td wire:click="freeze({{$owner->id}})">
                                    {!!userStatus($owner->suspend)!!}</td>
