    ...
    <div class="card mb-5 mb-xl-10">
        <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
            ...
            <div class="card-title m-0">
                <h3 class="fw-bolder m-0">{{__("Update App Settings")}}</h3>
            </div>
        </div>
        <div id="kt_account_profile_details" class="collapse show">
            <form class="form">
                <div class="card-body border-top p-9">
                    <!--begin::Input group-->
                    <div class="row mb-6">
                        <x-label class="required">{{__("Facebook")}}</x-label>
                        <div class="col-lg-8">
                            <div class="row">
                                <div class="col-lg-12 fv-row">
                                    <x-input type="url" field="appSetting.facebook" wire:model="appSetting.facebook"
                    ...
                    <!--begin::Input group-->
                    <div class="row mb-6">
                        <x-label class="required">{{__("Twitter")}}</x-label>
                        <div class="col-lg-8">
                            <div class="row">
                                <div class="col-lg-12 fv-row">
                                    <x-input type="url" field="appSetting.twitter" wire:model="appSetting.twitter"
                                        placeholder="Twitter" />
                                </div>
                            </div>
                        </div>
                    ...
                    <!--begin::Input group-->
                    <div class="row mb-6">
                        <x-label class="required">{{__("Instagram")}}</x-label>
                        <div class="col-lg-8">
                            <div class="row">
                                <div class="col-lg-12 fv-row">
                                    <x-input type="url" field="appSetting.instagram" wire:model="appSetting.instagram"
                    ...
                    <!--begin::Input group-->
                    <div class="row mb-6">
                        <x-label class="required">{{__("Whats App")}}</x-label>
                        <div class="col-lg-8">
                            <div class="row">
                                <div class="col-lg-12 fv-row">
