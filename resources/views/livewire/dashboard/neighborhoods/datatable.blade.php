    ...
    <div class="card card-flush mt-6 mt-xl-9">
        ...
        <div class="card-header mt-5">
            <div class="card-title flex-column">
                <h3 class="fw-bolder mb-1">{{__("Neighborhoods")}}</h3>
                    ...
                    <table
                        ...
                        <tbody class="fs-6">
                            ...
                            <tr wire:loading.class="opacity-50">
                                ...
                                <td>{!!isActive($neighborhood->status)!!}</td>
                              
                                <td>{{$neighborhood->created_at->format('m-d-Y')}}</td>
                                <td>
                                    <div class="d-flex justify-content-end flex-shrink-0">
                                        @can('edit neighborhoods')
                                        <x-edit-button href="{{route('admin.neighborhoods.edit',$neighborhood)}}"/>
                                        @endcan
                                        @can('delete neighborhoods')
                                        <x-delete-record-button wire:click="confirm({{ $neighborhood->id }})"/>
                                        @endcan                                    
                                    </div>
                                </td>
                            </tr>
