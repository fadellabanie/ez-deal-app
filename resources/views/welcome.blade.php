...
<head>
    ...
    <!--=============== css  ===============-->
    <link type="text/css" rel="stylesheet" href="{{asset('application/assets/css/reset.css')}}">
    <link type="text/css" rel="stylesheet" href="{{asset('application/assets/css/plugins.css')}}">
    <link type="text/css" rel="stylesheet" href="{{asset('application/assets/css/style.css')}}">
    <link type="text/css" rel="stylesheet" href="{{asset('application/assets/css/rtl-style.css')}}">
...
<body>
    ...
    <div id="main">
        ...
        <header class="main-header">
            <!-- logo-->
            <a href="index.html" class="logo-holder"><img src="{{asset('application/assets/images/logo.png')}}"
                    alt=""></a>
            <!-- logo end-->
            <!-- header-search_btn-->
            ...
            <div class="show-reg-form modal-open avatar-img"
                data-srcav="{{asset('application/assets/images/avatar/3.jpg')}}"><i class="fal fa-user"></i>Sign In</div>
            <!-- header opt end-->
            <!-- lang-wrap-->
            <div class="lang-wrap">
                        ...
                        <ul class="no-list-style">
                            <li>
                                <div class="widget-posts-img"><a href="listing-single.html"><img
                                            src="{{asset('application/assets/images/gallery/thumbnail/1.png')}}"
                                            alt=""></a>
                                </div>
        ...
        <div id="wrapper">
            ...
            <div class="content">
                ...
                <section class="hero-section" data-scrollax-parent="true">
                    <div class="bg-tabs-wrap">
                        <div class="bg-parallax-wrap" data-scrollax="properties: { translateY: '200px' }">
                            <div class="bg bg_tabs" data-bg="{{asset('application/assets/images/bg/hero/1.jpg')}}"></div>
                    ...
                    <div class="container small-container">
                        ...
                        <div class="main-search-input-tabs  tabs-act fl-wrap">
                            <ul class="tabs-menu change_bg no-list-style">
                                <li><a href="#tab-inpt4" data-bgtab="{{asset('application/assets/images/bg/hero/1.jpg')}}">
                                        Hotels</a></li>
                                <li><a href="#tab-inpt3" data-bgtab="{{asset('application/assets/images/bg/hero/1.jpg')}}">
                                        Restaurants</a></li>
                                <li><a href="#tab-inpt2" data-bgtab="{{asset('application/assets/images/bg/hero/1.jpg')}}">
                                        Events</a></li>
                                <li class="current"><a href="#tab-inpt1"
                                        data-bgtab="{{asset('application/assets/images/bg/hero/1.jpg')}}"> Places</a></li>
                            </ul>
                            <!--tabs -->
                        ...
                        <div class="hero-categories fl-wrap">
                            <h4 class="hero-categories_title">Just looking around quick search by category :</h4>
                            <ul class="no-list-style">
                                <li><a href="listing.html"><i
                                            class="far fa-cheeseburger"></i><span>Restaurants</span></a></li>
                                <li><a href="listing.html"><i class="far fa-bed"></i><span>Hotels</span></a></li>
                                <li><a href="listing.html"><i class="far fa-shopping-bag"></i><span>Shops</span></a>
                                </li>
                                                ...
                                                <article class="geodir-category-listing fl-wrap">
                                                    <div class="geodir-category-img">
                                                        ...
                                                        <a href="listing-single.html"
                                                            ...
                                                            <img src="{{asset('application/assets/images/all/1.jpg')}}"
                                                                alt="">
                                                        </a>
                                                        ...
                                                        <div class="geodir-category-opt">
                                                            <div class="geodir-category-opt_title">
                                                                <h4><a href="listing-single.html">The Goggi
                                                                        Restaurant</a></h4>
                                                            ...
                                                            <div class="listing_carditem_footer fl-wrap">
                                                                ...
                                                                <div class="post-author"><a href="#"><img
                                                                            src="{{asset('application/assets/images/avatar/1.jpg')}}"
                                                ...
                                                <article class="geodir-category-listing fl-wrap">
                                                    <div class="geodir-category-img">
                                                        ...
                                                        <div class="geodir_status_date gsd_close"><i
                                                                class="fal fa-lock"></i>Close Now</div>
                                                        <div class="geodir-category-opt">
                                                            <div class="geodir-category-opt_title">
                                                                <h4><a href="listing-single.html">Gym in the Center</a>
                                                                </h4>
                                                                <div class="geodir-category-location"><a href="#"><i
                                            ...
                                            <div class="listing-item listing_carditem">
                                                <article class="geodir-category-listing fl-wrap">
                                                    <div class="geodir-category-img">
                                                        ...
                                                        <div class="geodir-category-opt">
                                                            <div class="geodir-category-opt_title">
                                                                <h4><a href="listing-single.html">Moonlight Hotel</a>
                                                                </h4>
                                                                <div class="geodir-category-location"><a href="#"><i
                                                                            class="fas fa-map-marker-alt"></i> 34-42
                                                                        Montgomery St , NY, USA</a></div>
                                            ...
                                            <div class="listing-item listing_carditem">
                                                <article class="geodir-category-listing fl-wrap">
                                                    <div class="geodir-category-img">
                                                        ...
                                                        <div class="geodir-category-opt">
                                                            <div class="geodir-category-opt_title">
                                                                <h4><a href="listing-single.html">Shop in Aurora
                                                                        Center</a></h4>
                                                                <div class="geodir-category-location"><a href="#"><i
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <div class="listing-item-grid">
                                        <div class="bg" data-bg="{{asset('application/assets/images/all/1.jpg')}}"></div>
                ...
                <section class="parallax-section small-par" data-scrollax-parent="true">
                    <div class="bg par-elem " data-bg="{{asset('application/assets/images/bg/1.jpg')}}"
                                    ...
                                    <article class="geodir-category-listing fl-wrap">
                                        <div class="geodir-category-img">
                                            ...
                                            <a href="listing-single.html" class="geodir-category-img-wrap fl-wrap">
                                                <img src="{{asset('application/assets/images/all/1.jpg')}}" alt="">
                                            </a>
                                                    ...
                                                    <ul class="no-list-style">
                                                        ...
                                                        <li>
                                                            <div class="dynamic-gal gdop-list-link"
                                                                data-dynamicPath="[{'src': '{{asset('application/assets/images/all/1.jpg')}}'},{'src': '{{asset('application/assets/images/all/1.jpg')}}'}, {'src': '{{asset('application/assets/images/all/1.jpg')}}'}]">
                                ...
                                <div class="listing-item">
                                    <article class="geodir-category-listing fl-wrap">
                                        ...
                                        <div class="geodir-category-content fl-wrap title-sin_item">
                                            <div class="geodir-category-content-title fl-wrap ">
                                                <div class="geodir-category-content-title-item">
                                                    <h3 class="title-sin_map"><a href="listing-single.html">Rocko Band
                                                            in Marquee Club</a></h3>
                                                    <div class="geodir-category-location fl-wrap"><a href="#"><i
                                ...
                                <div class="listing-item">
                                    <article class="geodir-category-listing fl-wrap">
                                        <div class="geodir-category-img">
                                            ...
                                            <div class="geodir_status_date gsd_close"><i class="fal fa-lock"></i>Close
                                                Now</div>
                                            <div class="geodir-category-opt">
                                                <div class="listing-rating-count-wrap">
                                ...
                                <div class="listing-item">
                                    <article class="geodir-category-listing fl-wrap">
                                        <div class="geodir-category-img">
                                            ...
                                            <div class="geodir_status_date gsd_close"><i
                                                    class="fal fa-lock-open"></i>Close Now</div>
                                            <div class="geodir-category-opt">
                                                <div class="listing-rating-count-wrap">
                                                    <div class="review-score">4.1</div>
                                                    <div class="listing-rating card-popup-rainingvis"
                                        ...
                                        <div class="geodir-category-content fl-wrap title-sin_item">
                                            <div class="geodir-category-content-title fl-wrap">
                                                <div class="geodir-category-content-title-item">
                                                    <h3 class="title-sin_map"><a href="listing-single.html">Iconic Cafe
                                                            in Manhattan</a><span class="verified-badge"><i
                                                                class="fal fa-check"></i></span></h3>
                                                    <div class="geodir-category-location fl-wrap"><a href="#"><i
                                                    ...
                                                    <ul class="no-list-style">
                                                        ...
                                                        <li><a href="#" class="single-map-item"
                                                                ...
                                                                data-newlongitude="-73.84357452"><i
                                                                    class="fal fa-map-marker-alt"></i><span
                                                                    class="geodir-opt-tooltip">On the map
                                                                    <strong>7</strong></span> </a></li>
                                                        <li>
                                                            <div class="dynamic-gal gdop-list-link"
                                                                data-dynamicPath="[{'src': '{{asset('application/assets/images/all/1.jpg')}}'},{'src': '{{asset('application/assets/images/all/1.jpg')}}'}]">
                                                                <i class="fal fa-search-plus"></i><span
                                                                    class="geodir-opt-tooltip">Gallery</span></div>
                                                        </li>
                                                    </ul>
                                ...
                                <div class="listing-item">
                                    <article class="geodir-category-listing fl-wrap">
                                        ...
                                        <div class="geodir-category-content fl-wrap title-sin_item">
                                            <div class="geodir-category-content-title fl-wrap">
                                                <div class="geodir-category-content-title-item">
                                                    <h3 class="title-sin_map"><a href="listing-single.html">Family
                                                            Store</a></h3>
                                                    <div class="geodir-category-location fl-wrap"><a href="#"><i
                                                                class="fas fa-map-marker-alt"></i> 34-42 Montgomery St ,
                                                            NY, USA</a></div>
                ...
                <section class="parallax-section" data-scrollax-parent="true">
                    ...
                    <div class="container">
                        <div class="video_section-title fl-wrap">
                            ...
                            <h2>Get ready to start your exciting journey. <br> Our agency will lead you through the
                                amazing digital world</h2>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="collage-image">
                                    <img src="{{asset('application/assets/images/api.png')}}" class="main-collage-image"
                                        alt="">
                                    <div class="images-collage-title color2-bg icdec"> <img
                                            src="{{asset('application/assets/images/logo.png')}}" alt=""></div>
                                    <div class="images-collage_icon green-bg" style="right:-20px; top:120px;"><i
                                            class="fal fa-thumbs-up"></i></div>
                                    <div class="collage-image-min cim_1"><img
                                            src="{{asset('application/assets/images/api/1.jpg')}}" alt=""></div>
                                    <div class="collage-image-min cim_2"><img
                                            src="{{asset('application/assets/images/api/1.jpg')}}" alt=""></div>
                ...
                <section>
                    <div class="container">
                        <div class="section-title">
                            ...
                            <span class="section-separator"></span>
                            <p>Maecenas in pulvinar neque. Nulla finibus lobortis pulvinar. Donec a consectetur nulla.
                            </p>
                        </div>
                    </div>
                    <div class="clearfix"></div>
                    <div class="testimonilas-carousel-wrap fl-wrap">
                        <div class="listing-carousel-button listing-carousel-button-next"><i
                                class="fas fa-caret-right"></i></div>
                        <div class="listing-carousel-button listing-carousel-button-prev"><i
                                class="fas fa-caret-left"></i></div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="testi-item fl-wrap">
                                            <div class="testi-avatar"><img
                                                    src="{{asset('application/assets/images/avatar/1.jpg')}}" alt=""></div>
                    ...
                    <div class="waveWrapper waveAnimation">
                        <div class="waveWrapperInner bgMiddle">
                            <div class="wave-bg-anim waveMiddle"
                                style="background-image: url('{{asset('application/assets/images/wave-top.png')}}')">
                            </div>
                        </div>
                                    ...
                                    <div class="swiper-wrapper">
                                        ...
                                        <div class="swiper-slide">
                                            <a href="#" class="client-item"><img
                                                    src="{{asset('application/assets/images/clients/1.png')}}"
                                                    alt=""></a>
                                        </div>
                                        <!--client-item end-->
                                        <!--client-item-->
                        ...
                        <div class="col-md-4">
                            <div class="footer-widget fl-wrap">
                                <div class="footer-logo"><a href="index.html"><img
                                            src="{{asset('application/assets/images/logo.png')}}" alt=""></a></div>
                        ...
                        <div class="col-md-4">
                            <div class="footer-widget fl-wrap">
                                ...
                                <div class="footer-widget-posts fl-wrap">
                                    <ul class="no-list-style">
                                        <li class="clearfix">
                                            <a href="#" class="widget-posts-img"><img
                                                    src="{{asset('application/assets/images/all/1.jpg')}}" class="respimg"
                                                    alt=""></a>
                                            <div class="widget-posts-descr">
                                    ...
                                    <a href="blog.html" class="footer-link"><i class="fal fa-long-arrow-left"></i> Read
                                        all</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="footer-widget fl-wrap ">
                                ...
                                <div class="twitter-holder fl-wrap scrollbar-inner2" data-simplebar
                                    data-simplebar-auto-hide="false" data-simplebar-direction='rtl'>
                                    <div id="footer-twiit"></div>
                                </div>
                                <a href="#" class="footer-link twitter-link" target="_blank"><i
                                        class="fal fa-long-arrow-left"></i> Follow us</a>
                            </div>
                        </div>
                        <!-- footer-widget end-->
                    </div>
                ...
                <div class="main-register fl-wrap  modal_main">
                    ...
                    <div class="tabs-container">
                        ...
                        <div class="soc-log fl-wrap">
                            <p>For faster login or register your social account.</p>
    ...
    <!-- Main end -->
    <!--=============== scripts  ===============-->
    <script src="{{asset('application/assets/js/jquery.min.js')}}"></script>
    <script src="{{asset('application/assets/js/plugins.js')}}"></script>
    <script src="{{asset('application/assets/js/scripts.js')}}"></script>
    <script
        src="https://maps.googleapis.com/maps/api/js?key=YOUR_API_KEY_HERE&language=ar&libraries=places&callback=initAutocomplete">
    </script>
    <script src="{{asset('application/assets/js/map-single.js')}}"></script>
</body>
