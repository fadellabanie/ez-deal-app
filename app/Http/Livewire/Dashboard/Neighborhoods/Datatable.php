...
class Datatable extends Component
{
    ...
    {
        $row = Neighborhood::findOrFail($this->data_id);
        $row->delete();
    ...
    {
        return view('livewire.dashboard.neighborhoods.datatable',[
            'neighborhoods' => Neighborhood::orderBy($this->sortBy, $this->sortDirection)
            ->paginate($this->count),
        ]);
    }
